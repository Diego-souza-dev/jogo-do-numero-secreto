# 📌 Jogo do Número Secreto (Projeto da aula Alura)
>  Jogo desenvolvido para treinamento de Lógicas de programação e sobre Git e Github

## 🚧 Status do Projeto
Finalizado ✔️

## 💻 Tecnologias Utilizadas
As principais ferramentas e linguagens que usei para construir este projeto:
- HTML
- JavaScript
- CSS
